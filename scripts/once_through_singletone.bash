...
bwa mem -t 12 $REF_GENOME $INPUT_DIR/"${accession}"_1.fastq $INPUT_DIR/"${accession}"_2.fastq > $OUTPUT_DIR/aln_"${accession}".sam

samtools view -@ $SLURM_NTASKS -b aln_"${accession}".sam |\
